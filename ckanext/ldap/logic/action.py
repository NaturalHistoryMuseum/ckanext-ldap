...
def add_ckan_user(context,data_dict):
    ...
    user_org = _check_mail_org(ldap_user_dict['email'],prefix)
    if user_org:
        plugins.toolkit.get_action('member_create')(
            context={'ignore_auth': True},
            data_dict={
...
def _check_mail_org(user_email,prefix):
    ...
    ccca_mails = [u'aau.at',u'ages.at',u'ait.ac.at',u'alps-gmbh.com',u'badw.de',u'bfw.ac.at',u'boku.ac.at', u'ccca.ac.at', u'essl.org',u'geologie.ac.at',u'iiasa.ac.at',u'indoek.at',u'joanneum.at', u'oeaw.ac.at', u'meteorologie.at', u'tugraz.at', u'tuwien.ac.at', u'umweltbundesamt.at',u'uibk.ac.at',u'uma.or.at',u'sbg.ac.at', u'univie.ac.at',u'vetmeduni.ac.at', u'uni-graz.at', u'wifo.ac.at', u'weatherpark.com', u'wu.ac.at',u'zamg.ac.at', u'zsi.at',u'none.at']
    ...
    if prefix:
        print prefix
        mail_to_check = mail_to_check.split(prefix + '.')
        if len(mail_to_check)>1:
            mail_to_check = mail_to_check[1]
        print mail_to_check
