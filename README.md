...
-  `ckanext.ldap.enabledebugging = yes` : It will help to add ldap filter correctly. ldap.set_option(ldap.OPT_DEBUG_LEVEL, 4095) and trace_level=2 will be activated with option yes.
