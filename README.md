...
- `ckanext.ldap.debug_level`: default value 0. Also try option as 255 or 4095. https://www.python-ldap.org/en/latest/reference/ldap.html?highlight=debug%20level#ldap.OPT_DEBUG_LEVEL
